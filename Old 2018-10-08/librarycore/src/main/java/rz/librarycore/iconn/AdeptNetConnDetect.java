...
public class AdeptNetConnDetect {
    private static AdeptNetConnDetect instance = null;
    public static AdeptNetConnDetect getInstance() {
        if (instance == null) {
            instance = new AdeptNetConnDetect();
        }
        return instance;
    }
    public boolean isConnected(Context argContext) {
        ...
        if (hasPermission != PackageManager.PERMISSION_GRANTED) {
            System.out.println("Please set the permission INTERNET");
            return false;
        }
        hasPermission = ContextCompat.checkSelfPermission((Activity) argContext, Manifest.permission.ACCESS_NETWORK_STATE);
        if (hasPermission != PackageManager.PERMISSION_GRANTED) {
            System.out.println("Please set the permission ACCESS_NETWORK_STATE");
            return false;
        }
