...
public class PathManager {
    ...
    public PathManager(Context argContext) {
        context = argContext;
    }
    ...
    public String getRequestRootPath(PathManager argPathManager, String argStrPath) {
        return argPathManager.getRootCacheDirectory(argStrPath).toString();
    }

    public String getRequestCachePath(PathManager argPathManager, String argStrPath) {
        return argPathManager.getRootCacheDirectory(argStrPath).toString();
    }
