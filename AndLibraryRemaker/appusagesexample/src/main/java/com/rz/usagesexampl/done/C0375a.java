...
import com.rz.usagesexampl.done.RedirectWindow.OnEventListener;
...
class C0375a {
    ...
    private OnEventListener f1130i;
    ...
    protected C0375a(Activity activity, Context context) {
        ...
        this.f1132k = "CoreRedirectWindow(Activity argActivity, Context argContext)";
    ...
    protected C0375a m1452a(Bundle bundle) {
        this.f1132k = "withBundle(Bundle argBundle)";
    ...
    protected C0375a m1451a() {
        this.f1132k = "withFlag()";
        m1446a(C0374a.FLAG);
        return this;
    }

    protected C0375a m1456b() {
        this.f1132k = "disposeWindow()";
        m1446a(C0374a.DISPOSE);
        return this;
    }

    protected void m1453a(Class<?> cls) {
        this.f1132k = "execute(Class<?> argRedirectClass)";
    ...
    protected void m1454a(Class<?> cls, int i) {
        this.f1132k = "execute(Class<?> argRedirectClass, int argTimeMilliseconds)";
        m1446a(C0374a.EXECUTE);
        this.f1127f = cls;
    ...
    protected void m1455a(Class<?> cls, int i, OnEventListener c0376a) {
        this.f1132k = "execute(Class<?> argRedirectClass, int argTimeMilliseconds, RedirectWindow.OnEventListener argOnEventListener)";
        m1446a(C0374a.EXECUTE);
        this.f1127f = cls;
        this.f1130i = c0376a;
        this.f1129h = new Handler();
